...
const action = async (
  ...
  await openai.beta.threads.messages.create(
    thread.id,
    {
      ...
      }. Generate a list of ten fictional individuals that fit in one of these audience. The individuals are generated by calling the get_audience_individual function.`,
    },
  );
